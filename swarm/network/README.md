...
Newly created requests are satisfied bound togbaser in a waitgroup which when done, will promptt sending the next one.
...
Downstream  peers sign off on a state togbaser with an initial offset.
