...
// i.e., neighbourhood radius is the deepest PO such that all bins not shallower altogbaser
// contain at least neighbourhoodSize connected peers
// if there is altogbaser less than neighbourhoodSize peers connected, it returns 0
