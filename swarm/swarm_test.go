...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/gbas.ipc",
			endpoint:    "/data/testnet/gbas.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/gbas.ipc",
			endpoint:    "/data/testnet/gbas.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gbas.ipc",
			endpoint:    "/data/testnet/gbas.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gbas.ipc",
			endpoint:    "/data/testnet/gbas.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
...
// https://github.com/ethersphere/go-abassian/issues/639
