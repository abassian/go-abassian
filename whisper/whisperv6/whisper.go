...
// Whisper represents a dark communication interface through the Abassian
...
// New creates a Whisper client ready to communicate through the Abassian P2P network.
