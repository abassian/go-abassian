...
import (
	...
	"github.com/abassian/go-abassian/internal/jsre"
	"github.com/abassian/go-abassian/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute Abassian requests through
...
func (c *Console) init(preload []string) error {
	...
	if _, err := c.jsre.Run("web3.bas = web3.eth;"); err != nil {
		return fmt.Errorf("web3 eth alias: %v", err)
	}
	...
	flatten := "var eth = web3.eth; var bas = web3.eth; var personal = web3.personal; "
	for api := range apis {
		if api == "web3" {
...
// Welcome show summary of current Gbas instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Gbas metadata
	fmt.Fprintf(c.printer, "Welcome to the Gbas JavaScript console!\n\n")
	c.jsre.Run(`
	...
	if apis, err := c.client.SupportedModules(); err == nil {
		...
		fmt.Fprintln(c.printer, strings.Replace(" modules: " + strings.Join(modules, " ") + "\n", " eth:", " bas: ", -1))
	}
