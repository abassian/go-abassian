...
type wizard struct {
	...
	services map[string][]string   // Abassian services known to be running on servers
...
// converts it to an Abassian address. If an empty line is entered, the default
// value is returned.
