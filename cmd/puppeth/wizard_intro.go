...
// setting up a new or managing an existing Abassian private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Abassian private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Abassian network down to  |")
	...
	log.Info("Administering Abassian network", "name", w.network)
