...
// Tests the go-abassian to Aleth chainspec conversion for the Stureby testnet.
func TestAlethSturebyConverter(t *testing.T) {
	blob, err := ioutil.ReadFile("testdata/stureby_gbas.json")
	if err != nil {
...
// Tests the go-abassian to Parity chainspec conversion for the Stureby testnet.
