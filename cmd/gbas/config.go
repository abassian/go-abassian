...
func loadConfig(file string, cfg *gbasConfig) error {
	f, err := os.Open(file)
	if err != nil {
		return err
	}
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "gbas.ipc"
	return cfg
}

func makeConfigNode(ctx *cli.Context) (*node.Node, gbasConfig) {
	// Load defaults.
	cfg := gbasConfig{
...
func makeFullNode(ctx *cli.Context) *node.Node {
	...
	// Add the Abassian Stats daemon if requested.
	if cfg.Ethstats.URL != "" {
