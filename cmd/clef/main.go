...
import (
	...
	"github.com/abassian/go-abassian/signer/core"
	"github.com/abassian/go-abassian/signer/rules"
	"github.com/abassian/go-abassian/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Abassian account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
