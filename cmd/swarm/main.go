...
import (
	...
	"github.com/abassian/go-abassian/swarm"
	bzzapi "github.com/abassian/go-abassian/swarm/api"
	swarmmetrics "github.com/abassian/go-abassian/swarm/metrics"
	"github.com/abassian/go-abassian/swarm/storage/mock"
	mockrpc "github.com/abassian/go-abassian/swarm/storage/mock/rpc"
...
// This init function sets defaults so cmd/swarm can run alongside gbas.
func init() {
...
var app = utils.NewApp("", "Abassian Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.Version = sv.ArchiveVersion(gitCommit)
	app.Copyright = "Copyright 2013-2016 The go-abassian Authors"
...
func bzzd(ctx *cli.Context) error {
	...
	//gbas only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for gbas and swarm
