...
// that address/topic, and binary AND-ing those vectors togbaser.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them togbaser
				var orVector []byte
...
// the requested retrieval queue to be serviced togbaser with other sessions.
//
