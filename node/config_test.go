...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gbas.ipc", false, filepath.Join(os.TempDir(), "gbas.ipc")},
		{"data", "gbas.ipc", false, "data/gbas.ipc"},
		{"data", "./gbas.ipc", false, "./gbas.ipc"},
		{"data", "/gbas.ipc", false, "/gbas.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gbas.ipc", true, `\\.\pipe\gbas.ipc`},
		{"data", "gbas.ipc", true, `\\.\pipe\gbas.ipc`},
		{"data", `\\.\pipe\gbas.ipc`, true, `\\.\pipe\gbas.ipc`},
	}
