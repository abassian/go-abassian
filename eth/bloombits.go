...
import (
	...
	"github.com/abassian/go-abassian/common/bitutil"
...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Abassian
...
func (eth *Abassian) startBloomHandlers(sectionSize uint64) {
...
// for the Abassian header bloom filters, permitting blazing fast filtering.
