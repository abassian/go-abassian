...
#ifndef USE_NUM_NONE
    {
        /* Test that adding the scalars togbaser is equal to adding their numbers togbaser modulo the order. */
        secp256k1_num rnum;
        secp256k1_num r2num;
        secp256k1_scalar r;
...
void test_ge(void) {
    ...
    /* Test adding all points togbaser in random order equals infinity. */
    {
