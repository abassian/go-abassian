...
// Package accounts implements high level Abassian account management.
package accounts
...
// Account represents an Abassian account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Abassian account address derived from the key
