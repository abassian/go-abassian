...
const (
	...
	MessageType_MessageType_AbassianGetAddress       MessageType = 56
	MessageType_MessageType_AbassianAddress          MessageType = 57
	MessageType_MessageType_AbassianSignTx           MessageType = 58
	MessageType_MessageType_AbassianTxRequest        MessageType = 59
	MessageType_MessageType_AbassianTxAck            MessageType = 60
	...
	MessageType_MessageType_AbassianSignMessage      MessageType = 64
	MessageType_MessageType_AbassianVerifyMessage    MessageType = 65
	MessageType_MessageType_AbassianMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_AbassianGetAddress",
	57:  "MessageType_AbassianAddress",
	58:  "MessageType_AbassianSignTx",
	59:  "MessageType_AbassianTxRequest",
	60:  "MessageType_AbassianTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_AbassianSignMessage",
	65:  "MessageType_AbassianVerifyMessage",
	66:  "MessageType_AbassianMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_AbassianGetAddress":       56,
	"MessageType_AbassianAddress":          57,
	"MessageType_AbassianSignTx":           58,
	"MessageType_AbassianTxRequest":        59,
	"MessageType_AbassianTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_AbassianSignMessage":      64,
	"MessageType_AbassianVerifyMessage":    65,
	"MessageType_AbassianMessageSignature": 66,
...
// *
// Request: Ask device for Abassian address corresponding to address_n path
// @next PassphraseRequest
// @next AbassianAddress
// @next Failure
type AbassianGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *AbassianGetAddress) Reset()                    { *m = AbassianGetAddress{} }
func (m *AbassianGetAddress) String() string            { return proto.CompactTextString(m) }
func (*AbassianGetAddress) ProtoMessage()               {}
func (*AbassianGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *AbassianGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *AbassianGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Abassian address derived from device private seed
// @prev AbassianGetAddress
type AbassianAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *AbassianAddress) Reset()                    { *m = AbassianAddress{} }
func (m *AbassianAddress) String() string            { return proto.CompactTextString(m) }
func (*AbassianAddress) ProtoMessage()               {}
func (*AbassianAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *AbassianAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next AbassianTxRequest
// @next Failure
type AbassianSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *AbassianSignTx) Reset()                    { *m = AbassianSignTx{} }
func (m *AbassianSignTx) String() string            { return proto.CompactTextString(m) }
func (*AbassianSignTx) ProtoMessage()               {}
func (*AbassianSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *AbassianSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *AbassianSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *AbassianSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *AbassianSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *AbassianSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *AbassianSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *AbassianSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *AbassianSignTx) GetDataLength() uint32 {
...
func (m *AbassianSignTx) GetChainId() uint32 {
...
func (m *AbassianTxRequest) Reset()                    { *m = AbassianTxRequest{} }
func (m *AbassianTxRequest) String() string            { return proto.CompactTextString(m) }
func (*AbassianTxRequest) ProtoMessage()               {}
func (*AbassianTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *AbassianTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *AbassianTxRequest) GetSignatureV() uint32 {
...
func (m *AbassianTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *AbassianTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev AbassianTxRequest
// @next AbassianTxRequest
type AbassianTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *AbassianTxAck) Reset()                    { *m = AbassianTxAck{} }
func (m *AbassianTxAck) String() string            { return proto.CompactTextString(m) }
func (*AbassianTxAck) ProtoMessage()               {}
func (*AbassianTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *AbassianTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next AbassianMessageSignature
// @next Failure
type AbassianSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *AbassianSignMessage) Reset()                    { *m = AbassianSignMessage{} }
func (m *AbassianSignMessage) String() string            { return proto.CompactTextString(m) }
func (*AbassianSignMessage) ProtoMessage()               {}
func (*AbassianSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *AbassianSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *AbassianSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type AbassianVerifyMessage struct {
...
func (m *AbassianVerifyMessage) Reset()                    { *m = AbassianVerifyMessage{} }
func (m *AbassianVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*AbassianVerifyMessage) ProtoMessage()               {}
func (*AbassianVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *AbassianVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *AbassianVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *AbassianVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev AbassianSignMessage
type AbassianMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *AbassianMessageSignature) Reset()                    { *m = AbassianMessageSignature{} }
func (m *AbassianMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*AbassianMessageSignature) ProtoMessage()               {}
func (*AbassianMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *AbassianMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *AbassianMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*AbassianGetAddress)(nil), "AbassianGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*AbassianAddress)(nil), "AbassianAddress")
	...
	proto.RegisterType((*AbassianSignTx)(nil), "AbassianSignTx")
	proto.RegisterType((*AbassianTxRequest)(nil), "AbassianTxRequest")
	proto.RegisterType((*AbassianTxAck)(nil), "AbassianTxAck")
	proto.RegisterType((*AbassianSignMessage)(nil), "AbassianSignMessage")
	proto.RegisterType((*AbassianVerifyMessage)(nil), "AbassianVerifyMessage")
	proto.RegisterType((*AbassianMessageSignature)(nil), "AbassianMessageSignature")
