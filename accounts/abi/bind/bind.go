...
// Package bind generates Abassian contract Go bindings.
//
// Detailed usage document and tutorial available on the go-abassian Wiki page:
// https://github.com/abassian/go-abassian/wiki/Native-DApps:-Go-bindings-to-Abassian-contracts
package bind
