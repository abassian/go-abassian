...
type ContractCaller interface {
	...
	// ContractCall executes an Abassian contract call with the specified data as the
	// input.
...
type PendingContractCaller interface {
	...
	// PendingCallContract executes an Abassian contract call against the pending state.
