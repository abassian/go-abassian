...
// all blocks' seal as valid, though they still have to conform to the Abassian
// consensus rules.
...
// still have to conform to the Abassian consensus rules.
...
// they still have to conform to the Abassian consensus rules.
