...
import (
	...
	"github.com/abassian/go-abassian/consensus/misc"
...
// ecrecover extracts the Abassian account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Abassian address
...
// Abassian testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Abassian address of the signing key
...
// Author implements consensus.Engine, returning the Abassian address recovered
