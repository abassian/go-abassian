...
// Service implements an Abassian netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Abassian      // Full Abassian service if monitoring a full node
	les    *les.LightAbassian // Light Abassian service if monitoring a light node
...
func New(url string, ethServ *eth.Abassian, lesServ *les.LightAbassian) (*Service, error) {
