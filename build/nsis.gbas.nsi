...
# 1. install gbas for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gbas
# 5. create gbas, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable ABASSIAN_SOCKET
...
!define GROUPNAME "Abassian"
!define APPNAME "Gbas"
!define DESCRIPTION "Official Go implementation of the Abassian protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gbas is installed global
