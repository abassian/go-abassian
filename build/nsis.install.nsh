Name "gbas ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/abassian/go-abassian/issues"
!define UPDATEURL "https://github.com/abassian/go-abassian/releases"
!define ABOUTURL "https://github.com/abassian/go-abassian#ethereum-go"
...
# Install gbas binary
Section "Gbas" GBAS_IDX
  SetOutPath $INSTDIR
  file {{.Gbas}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gbas.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gbas.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gbas incoming peers (TCP:30313)"
  SimpleFC::AdvRemoveRule "Gbas outgoing peers (TCP:30313)"
  SimpleFC::AdvRemoveRule "Gbas UDP discovery (UDP:30313)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gbas incoming peers (TCP:30313)" ""  6 1 1 2147483647 1 "$INSTDIR\gbas.exe" "" "" "Abassian" 30313 "" "" ""
  SimpleFC::AdvAddRule "Gbas outgoing peers (TCP:30313)" ""  6 2 1 2147483647 1 "$INSTDIR\gbas.exe" "" "" "Abassian" "" 30313 "" ""
  SimpleFC::AdvAddRule "Gbas UDP discovery (UDP:30313)" "" 17 2 1 2147483647 1 "$INSTDIR\gbas.exe" "" "" "Abassian" "" 30313 "" ""

  # Set default IPC endpoint (https://github.com/abassian/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ABASSIAN_SOCKET" "R" "HKLM" "\\.\pipe\gbas.ipc"
  ${EnvVarUpdate} $0 "ABASSIAN_SOCKET" "A" "HKLM" "\\.\pipe\gbas.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GBAS_IDX}
    SectionGetSize ${GBAS_IDX} $0
